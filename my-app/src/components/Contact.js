 export default function Contact() {
    return (
        <div id="contact" className="relative flex flex-col mt-30 items-center">
            <h2 className="text-6xl md:text-7xl mb-16">Want To</h2>
            ...
            <div 
                className="mt-5 mb-5 lg:mt-15 lg:mb-10 text-md md:text-xl lg:text-3xl flex justify-center space-x-4 md:space-x-10 lg:space-x-20"
                data-aos="fade-right"
                data-aos-delay="700"
            > 
